...
require (
	...
	github.com/kava-labs/binance-chain-ledger-cosmos-go v0.9.9-binance.1-kava1 // indirect
	github.com/kava-labs/go-amino v0.14.1-kava // indirect
	github.com/kava-labs/tendermint v0.32.3-kava1 // indirect
	github.com/kava-labs/tm-db v0.1.1-kava // indirect
